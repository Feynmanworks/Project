...
#define		SAMPLE_FREQ	"????"		/* frequency between 4 and 8 KHz		*/
//	Choose the size of samples buffer
#define		SIZE_BUFF	"????"		/* value between 1000 and 4000	*/
// ##TAG##1 end
...
//------------------------------------------------------------------------------
{
	...
	// call a function to read one buffer of samples
	//
